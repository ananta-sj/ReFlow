...
# --- THEME CONFIGURATION ---
# Modeled after your "Crypto Dashboard" (Image 2) and "Neon Trends" (Image 3)
COLORS = {
    ...
    "accent":       ("#6366F1", "#6C5CE7"),  # Indigo / Neon Purple (From Image 3)
...
class StatWidget(ctk.CTkFrame):
    """Mini Dashboard Widget (Matches Image 2 Cards)"""
...
class JobCard(ctk.CTkFrame):
    ...
    def __init__(self, parent, index, filepath, status="Pending"):
        ...
        # Using simple text char as icon, but styled to look graphical
...
class ReFlowStudio(ctk.CTk):
    def __init__(self):
        ...
        # --- START BUTTON (Floating Pill Style) ---
        self.btn_start = ctk.CTkButton(self.sidebar, text="START QUEUE  ▶", 
                                       fg_color=COLORS["accent"], hover_color=COLORS["accent_hover"],
                                       height=50, corner_radius=25, # High radius = Pill shape
                                       font=("Segoe UI", 13, "bold"),
                                       text_color="white", 
                                       command=self.start_batch)
        # Pack with padding to make it "float"
    ...
    def add_switch(self, text, default, parent, attr_name):
        sw = ModernSwitch(parent, text, default)
